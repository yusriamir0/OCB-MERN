...
// kirakan purata
let tambahanSemua = 0;
let jumlahNilaiDalamArray = markah.length; // tujuan letak length property untuk tahu berapa jumlah yang ada dalam array. dalam kes ni jumlahnya ialah 7 nilai
...
const purataMarkah = Math.round(tambahanSemua / jumlahNilaiDalamArray); // Math.round() untuk perbundaran
...
let dapatkanGred = markah.filter(function (markah) {
    if (markah >= 80) {
        // A = 80 --> 100
        console.log("Markah " + markah + "% ialah gred A");
    } else if (markah >= 70 && markah <= 79) {
        // B = 70 --> 79
        console.log("Markah " + markah + "% ialah gred B");
    } else if (markah >= 40 && markah <= 69) {
        // C = 40 --> 69
        console.log("Markah " + markah + "% ialah gred C");
    } else {
        // F = less than 40
        console.log("Markah " + markah + "% ialah gred D");
    }
});
...
const gabungSemuaKarakter = perkataan + nombor + simbol;

let panjangKarakter = "";

// const panjangKaraktor = gabungSemuaKaraktor.length;
